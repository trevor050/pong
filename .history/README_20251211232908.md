...
the vibe here is: take that idea, slow it down a little, make it prettier, and turn it into something you can just leave up on a second screen. basically a tiny drifting screensaver.
...
- **resizable frame** (drag corners) + fullscreen support
